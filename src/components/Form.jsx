...
export const Form = ()=>{
   ...
   return (
    ...
    <form id="contact" className="flex flex-col gap-4 items-center justify-center backdrop-blur-sm mt-8 p-5" onSubmit={handleSubmit}>
        ...
        <input name="email" className="w-75 sm:w-160 bg-zinc-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" value={form.email} onChange={(e)=>handleChange(e)} placeholder="E-mail" />
