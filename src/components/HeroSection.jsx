...
export const HeroSection = ()=>{
    ...
    return (
        ...
        <h1 className="text-white text-2x1 xl:text-4xl">Frontend Developer · <span className="text-violet-400">React</span></h1>
        <p className=" text-white text-4xl xl:text-7xl font-semibold">Hola, soy {" "}<span className="text-violet-500">Lucas Caño.</span></p>
        ...
        <div className="xl:mt-20">
                <a className="relative group inline-block rounded-2xl xl:m-10 p-4 m-4  shadow-[0_0_15px_rgba(255,255,255,0.3)] cursor-pointer transition transform hover:scale-110 hover:shadow-[0_0_15px_rgba(75,0,130,1)]" href="https://github.com/Lucas0894">
                ...
                <a className="relative group inline-block rounded-2xl xl:m-10 p-4 m-4  shadow-[0_0_15px_rgba(255,255,255,0.3)] cursor-pointer transition transform hover:scale-110 hover:shadow-[0_0_15px_rgba(75,0,130,1)]" href="http://www.linkedin.com/in/lucas-ca%C3%B1o-0a5406223">
                ...
                <a className="relative group inline-block rounded-2xl xl:m-10 p-4 m-4  shadow-[0_0_15px_rgba(255,255,255,0.3)] cursor-pointer transition transform hover:scale-110 hover:shadow-[0_0_15px_rgba(75,0,130,1)]" href={LucasC_CV} download>
            ...
            <img alt="img Lucas" src={lucas} className="mt-6 w-60 h-60 xl:w-130 xl:h-130 object-cover mask-radial-from-50% mask-radial-to-70% shadow-[0_0_35px_rgba(139,92,246,0.35)]" />
        </section>
    )
}