...
export const HeroSection = ()=>{
  ...
  useEffect(() => {
    const timer = setTimeout(() => setLoopKey(prev => prev + 1), 4000);
    ...
    return (
        ...
        <h1 className="text-white text-2xl xl:text-4xl"><TypeAnimation key={loopKey} sequence={["Frontend Developer · ",1500, "", 500]} speed={50}repeat={0}/><span className="text-indigo-400">React</span></h1>
