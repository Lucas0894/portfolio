...
export const HeroSection = ()=>{
    ...
    return (
        ...
        <h1 className="text-white text-2xl xl:text-4xl"><TypeAnimation sequence={["Frontend Developer · ",1500, "", 500]} speed={50}repeat={Infinity}/><span className="text-indigo-400">React</span></h1>
