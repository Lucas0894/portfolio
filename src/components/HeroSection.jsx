...
export const HeroSection = ()=>{
    ...
    return (
        ...
        <div className="xl:mt-20">
                <a className="relative bg-[#202020] group inline-block rounded-2xl xl:m-10 p-4 m-6  shadow-[0_6px_16px_rgba(0,0,0,0.45),0_28px_55px_rgba(0,0,0,0.85)] cursor-pointer transition transform hover:scale-110 hover:shadow-[0_6px_16px_rgba(99,102,241,0.35),0_28px_55px_rgba(99,102,241,0.55)]" href="https://github.com/Lucas0894">
